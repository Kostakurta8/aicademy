...
function AITutorInner() {
  ...
  const updateLastAssistantMessage = useAIStore(
  ...
  return (
    <>
      ...
      {/* Chat panel */}
      {tutorOpen && (
        <div className="animate-fade-in fixed bottom-24 md:bottom-6 right-4 md:right-6 z-[60] w-[calc(100vw-2rem)] md:w-[380px] h-[min(540px,calc(100vh-8rem))] md:h-[540px] bg-surface border border-border-subtle rounded-2xl shadow-2xl overflow-hidden flex flex-col">
          {/* Header */}
            ...
            <div className="border-b border-border-subtle bg-surface-raised p-2 max-h-[150px] overflow-y-auto">
              ...
              {conversations.map((conv) => (
                ...
                >
                  ...
                  <span className="text-text-muted text-[10px] flex-shrink-0 ml-2">
            ...
            {messages.length === 0 && !isGenerating && (
              <div className="text-center py-8">
                ...
                <div className="flex flex-wrap gap-2 mt-4 justify-center">
                  {["What is an LLM?", "Explain tokens", "What is RAG?"].map(
                    (q) => (
                      <button
                        key={q}
                        onClick={() => {

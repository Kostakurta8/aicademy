...
import { playLevelUp, playXPDing } from "@/lib/sounds";
...
const features = [
  {
    ...
    desc: "Structured lessons from beginner to advanced",
  },
  {
    icon: Gamepad2,
    title: "13 Educational Games",
    desc: "Learn through play — earn XP and level up",
  },
  {
    icon: Zap,
    title: "AI Sandboxes",
    desc: "Hands-on tools with live AI responses",
  },
  {
    icon: Brain,
    title: "Prompt Engineering",
    desc: "Master the art of talking to AI",
  },
];
  ...
  return (
    <div className="fixed inset-0 z-[200] bg-bg flex items-center justify-center p-4 overflow-y-auto">
      <div className="w-full max-w-2xl">
        ...
        {/* Step 0: Welcome */}
        {step === 0 && (
          <div key="welcome" className="animate-fade-in text-center">
            <div className="animate-celebrate-pop w-20 h-20 mx-auto mb-6 rounded-2xl bg-gradient-to-br from-purple to-blue flex items-center justify-center">
            ...
            <p className="text-lg text-text-secondary mb-8 max-w-md mx-auto">
              Your interactive AI literacy journey starts here. Let&apos;s set
        ...
        {/* Step 1: Name & Avatar */}
        {step === 1 && (
          <div key="profile" className="animate-fade-in text-center">
            ...
            <p className="text-text-secondary mb-8">
              Pick a name and avatar — you can change these later in Settings.
            </p>

            <div className="max-w-sm mx-auto mb-8">
              <label
                htmlFor="onboarding-name"
                className="block text-sm font-medium text-text-secondary mb-2 text-left"
              >
                Your Name
              </label>
              <input
        ...
        {/* Step 2: Feature Tour */}
        {step === 2 && (
          <div key="tour" className="animate-fade-in text-center">
              ...
              {[
                {
                  icon: "📚",
                  title: "Learn",
                  desc: "Work through 8 modules with 3-layer lessons: Read → Apply → Reinforce.",
                },
                {
                  icon: "🎮",
                  title: "Practice",
                  desc: "13 educational games that test your knowledge — earn XP and level up.",
                },
                {
                  icon: "🧪",
                  title: "Experiment",
                  desc: "AI sandboxes let you build prompts, compare models, and test ideas live.",
                },
                {
                  icon: "📈",
                  title: "Track Progress",
                  desc: "XP, levels, streaks, skill profiles — watch yourself grow.",
                },
                {
                  icon: "🤖",
                  title: "AI Tutor",
                  desc: "Ask questions anytime — your AI assistant is always one click away.",
                },
              ].map((item, i) => (
                <div
                  key={item.title}
        ...
        {step === 3 && !completing && (
          <div key="level" className="animate-fade-in text-center">
            ...
            <p className="text-text-secondary mb-8">
              We&apos;ll tailor your first lesson based on your level.
            </p>
              ...
              {[
                {
                  ...
                  title: "I'm New to AI",
                  description:
                    "I want to start from scratch and learn the fundamentals step-by-step.",
                ...
                },
                {
                  ...
                  description:
                    "I've used AI tools before and want to deepen my skills with advanced topics.",
                ...
                >
                  <div className="flex items-center gap-4">
                    <div
                      className={`w-14 h-14 rounded-xl bg-gradient-to-br ${level.color} flex items-center justify-center shrink-0`}
                    >
        ...
        {completing && (
          <div key="completing" className="animate-fade-in text-center py-12">
            <div className="animate-celebrate-pop w-24 h-24 mx-auto mb-6 rounded-3xl bg-gradient-to-br from-purple via-blue to-cyan flex items-center justify-center">
            ...
            <p className="text-text-secondary mb-2">
              You earned <span className="text-accent font-bold">+50 XP</span>{" "}
        ...
        {/* Navigation buttons */}
        {!completing && (
          <div className="animate-fade-in flex items-center justify-between mt-10">
            {step > 0 ? (
              <Button
                variant="ghost"
